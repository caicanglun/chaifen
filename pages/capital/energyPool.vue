	...
	<view>
		...
		<view style="margin-top: 40upx;">
			<view class="flex_c" style="font-size: 14px;background: #23355d;height: 80upx;">
				...
				<view style="width: 50%;display: flex;justify-content: flex-end;padding-right: 20upx;">
					{{i18n.ecologyDetail.amount}}</view>
			</view>
	...
	export default {
		...
		methods:{
			async fetchMoreList(){
				...
				const res = await this.$http.get('/deal/energy_flow',{data: data})

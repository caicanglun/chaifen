			...
			<view class="content-1">
				...
				<view class='items'>
					<view style="display:flex;">
						<view @tap="tapReason" :class="dataIndex==1?'tabActiveReason':'ButtonReason'"  data-index="1">成交</view>
						<view @tap="tapReason" :class="dataIndex ==2?'tabActiveReason':'ButtonReason'" data-index="2">丢单</view>

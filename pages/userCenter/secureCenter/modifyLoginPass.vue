	...
	<view>
		...
		<view style="margin: 30upx 30upx;">
			<view style="font-size: 14px;height:80upx;" class="flex_c">
				<text style="padding-left: 10upx;">舊密碼</text>
			</view>
			<view style="background: #121c31;" class="flex_sb">
				<input v-model="form.oldPassword" type="password" class="inputClass"  placeholder="請輸入舊密碼" placeholder-class="placeholderClass"/>

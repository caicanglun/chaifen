...
var ServerUrl = "http://app.etfspro.com:8080/sl-web";
...
throw new Error("Module build failed (from ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader/index.js):\nError: ENOENT: no such file or directory, open '/Applications/HBuilderX.app/Contents/HBuilderX/plugins/uniapp-cli/node_modules/@vue/babel-preset-app/node_modules/@babel/runtime/regenerator/index.js'");
...
var UpdateVersion = function UpdateVersion() {
  ...
  var langArr = { 'zh-hk': _index.hk, 'zh-cn': _index.cn, 'en-us': _index.en, 'ko-kr': _index.ko, 'ru-ru': _index.ru, 'ja-jp': _index.ja };
...
UpdateVersion.prototype = {
  ...
  //热更新检测
  getNewData: function getNewData(type) {
    var _this = this;
  ...
  //弹出更新提示
  alertUpdateTips: function alertUpdateTips(url, forced_update, isDownloadPack) {
    var _this = this;
    if (forced_update == '1') {
  ...
  //下载安装包
  downloadPack: function downloadPack(url) {
    var _this = this;
    ...
    dtask.addEventListener("statechanged", function (download, status) {
      ...
      if (download.state == 3 && download.totalSize) {
        ...
        if (ds && totalSize) {
          w.setTitle("".concat(lang.updateProgress, ":").concat(ds, "M/").concat(totalSize, "M"));
        }
      }
    }, false);
    dtask.start();
  ...
  //安装
  installPack: function installPack(path) {
    var _this = this;
  ...
  //整包更新
  updatePackage: function updatePackage(url) {
    if (/\.apk$/.test(url)) {
...
UpdateVersion;exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default =
{
  currentVersionTip: '当前已经是最新版本',

  updateAlert: '已检测到新版本，该版本有重大更新，请立即更新',
  updateInquiry: '已检测到新版本，是否立即更新',
  tipBtn: '更新提示',
  tipBtn2: '立即更新',
  tipbtn3: '更新提示',
  confirm: '确定',
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  currentVersionTip: '현재 버전이 이미 최신 버전입니다',

  updateAlert: '새 버전이 발견되었습니다.이 버전에는 주요 업데이트가 있습니다. 지금 업데이트하십시오',
  updateInquiry: '새 버전이 감지되었습니다. 즉시 업데이트됩니까',
  tipBtn: '업데이트 힌트',
  tipBtn2: '지금 업데이트',
  tipbtn3: '업데이트 정보',
  confirm: '확인',
  ...
  downloading: '다운로드 업데이트를 닫지 마십시오',
  downloadFail: '다운로드 실패',
  installing: '업데이트 파일 설치...',
  installFail: '설치 실패',
  updateProgress: '업데이트 진도',
  reloadTip: '힌트 재기',
  nowReload: '즉시 재개',

  updateSuccess1: '최신 버전이 설치되었습니다. 지금 앱을 다시 시작 하시겠습니까?',
  updateSuccess2: '업데이트가 성공적으로 완료되었습니다. 앱을 다시 시작한 후 최신 버전을 사용할 수 있습니다！' };exports.default = _default;
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  updateSuccess2: 'Обновление прошло успешно, вы можете использовать последнюю версию после перезапуска приложения!' };exports.default = _default;
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default =
{
  currentVersionTip: '現在最新バージョン',

  updateAlert: '新しいバージョンが検出されました。このバージョンにはメジャーアップデートがあります。今すぐアップデートしてください',
  updateInquiry: '新しいバージョンが検出され、すぐに更新するかどうか',
  tipBtn: '更新のヒント',
  tipBtn2: '今すぐ更新',
  tipbtn3: '更新のヒント',
  confirm: 'OK',
  ...
  downloading: 'アップデートのダウンロード中は閉じないでください',
  downloadFail: 'ダウンロードに失敗しました',
  installing: '更新ファイルのインストール...',
  installFail: 'インストールに失敗しました',
  updateProgress: '進捗状況を更新',
  reloadTip: '再起動プロンプト',
  nowReload: '今すぐ再起動',

  updateSuccess1: '最新バージョンがインストールされています。今すぐ再起動してください',
  updateSuccess2: '更新が成功しました。アプリを再起動した後、最新バージョンを使用できます！' };exports.default = _default;
